...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    sub: "Nurture · attribution",
    out: "Lifecycle campaigns, data hygiene, and attribution running on autopilot across HubSpot and Salesforce.",
  },
  {
    id: "support",
    dept: "care",
    ...
    sub: "Tickets · triage",
    out: "Tickets triaged, answered, and resolved or escalated with full context attached.",
  },
  {
    id: "postsale",
    dept: "postsale",
    Icon: Star,
    name: "Warranties · reviews · testimonials",
    sub: "Retention",
    out: "Warranty registration, review requests, and testimonial capture triggered automatically after the sale.",
  },
];
