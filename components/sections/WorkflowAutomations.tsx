...
const WORKFLOWS: Workflow[] = [
  ...
  },
  {
    ...
    dept: "sales",
    Icon: Phone,
    name: "Speed-to-lead booking",
    sub: "Capture · qualify · schedule",
    src: "/workflows/callcenter-speed-to-lead.html",
    frame: "naples-exteriors · book-estimate",
    out: "Inbound lead → a guided estimate booking that captures, qualifies with a live service-area check, and self-schedules in under a minute — the speed-to-lead front door for inside sales.",
  },
  {
    id: "lifecycle",
    dept: "marketing",
