    ...
    <>
      ...
      <main id="main">
        ...
        <section className="relative isolate overflow-hidden border-b border-line">
          ...
          <div className="container-x pb-16 pt-28 sm:pt-32">
            <Link
              href="/#projects"
          ...
          <div className="container-x grid gap-10 lg:grid-cols-[1fr_1fr] lg:items-center">
            <Reveal>
              <div>
                ...
                <h2 className="text-3xl font-semibold sm:text-4xl">One assistant can&apos;t do everything</h2>
            ...
            <Reveal delay={0.08}>
              <div className="surface-card p-6">
                ...
                <ul className="mt-5 space-y-2">
                  {["Hard to maintain", "Risky to change", "Opaque failures", "Doesn't scale"].map((x) => (
          ...
          <div className="container-x">
            <Reveal>
              <div className="max-w-2xl">
                ...
                <h2 className="text-3xl font-semibold sm:text-4xl">Specialized agents, one orchestrator</h2>
                <div className="mt-5 space-y-4">
            ...
            <Reveal delay={0.08}>
              <p className="mt-10 max-w-3xl border-l-2 border-accent-cyan/60 pl-5 font-display text-2xl text-ink sm:text-3xl">
                {cs.solution.quote}
              </p>
            </Reveal>
          </div>
          ...
          <div className="container-x">
            <Reveal>
              <div className="max-w-2xl">
                ...
                <h2 className="text-3xl font-semibold sm:text-4xl">See the system run</h2>
                <p className="mt-4 text-base leading-relaxed text-ink-muted">{cs.demo.note}</p>
              </div>
            </Reveal>
            <Reveal delay={0.08}>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Launch the interactive Seinfeld HQ demo in a new tab"
          ...
          <div className="container-x">
            <Reveal>
              <div className="max-w-2xl">
                ...
                <p className="mt-4 text-base leading-relaxed text-ink-muted">{cs.architecture.intro}</p>
              </div>
            </Reveal>
        ...
        {/* 6. ONE ARCHITECTURE, MANY SKINS */}
        <section className="section border-b border-line/60">
          <div className="container-x">
            <Reveal>
              <div className="max-w-2xl">
                <p className="eyebrow mb-3">One Architecture, Many Skins</p>
                <h2 className="text-3xl font-semibold sm:text-4xl">{cs.skins.heading}</h2>
                <p className="mt-4 text-base leading-relaxed text-ink-muted">{cs.skins.body}</p>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.1}>
              <div className="mt-6 flex items-center justify-center gap-3 rounded-xl border border-dashed border-accent-cyan/30 bg-accent-cyan/[0.04] px-5 py-4 text-center">
                <Boxes size={16} className="text-accent-cyan" aria-hidden />
        ...
        <section className="section border-b border-line/60 bg-surface/30">
          <div className="container-x">
            <Reveal>
              <h2 className="max-w-2xl text-3xl font-semibold sm:text-4xl">{cs.demonstrates.heading}</h2>
            </Reveal>
            <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {cs.demonstrates.cards.map((c, i) => (
                <Reveal key={c} delay={(i % 3) * 0.05}>
                  <div className="flex items-center gap-3 rounded-xl border border-line bg-surface-elevated/70 px-5 py-4">
                    <Check size={16} className="shrink-0 text-accent-cyan" aria-hidden />
        ...
        <section className="section border-b border-line/60">
          <div className="container-x">
            <Reveal>
              ...
              <h2 className="text-3xl font-semibold sm:text-4xl">Built with</h2>
            </Reveal>
            <Reveal delay={0.08}>
              <ul className="mt-8 flex flex-wrap gap-2.5">
                {cs.tech.items.map((t) => (
                  <li
                    key={t}
                    className="rounded-md border border-line bg-surface-elevated/50 px-3.5 py-2 font-mono text-sm text-ink-muted"
                  >
                    {t}
                  </li>
                ))}
